...
const VirtualAssistant: React.FC<VirtualAssistantProps> = ({ 
      ...
      <div className="fixed bottom-6 right-6 z-50 animate-bounce">
        <div className="relative">
          <Button
            ...
            className="rounded-full h-20 w-20 shadow-2xl bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 transform hover:scale-110 transition-all duration-300"
            size="icon"
          >
  ...
  return (
    <Card className="w-full max-w-md h-[600px] flex flex-col shadow-2xl border-2 border-blue-200 bg-white backdrop-blur-sm animate-fade-in">
              ...
              >
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    {message.sender === 'user' && (
                      <User className="h-5 w-5 mt-0.5 flex-shrink-0 order-2 text-white" />
                    )}
        ...
        <div className="p-4 border-t bg-gray-50">
          <div className="flex gap-3">
            <Input
              ...
              placeholder="Digite seu problema de TI..."
              disabled={isLoading}
              className="flex-1 h-12 text-base rounded-xl border-2 border-gray-200 focus:border-blue-500 bg-white"
            />
            <Button 
              onClick={handleSendMessage} 
              disabled={!input.trim() || isLoading}
              size="icon"
              className="h-12 w-12 rounded-xl bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 transform hover:scale-105 transition-all duration-200"
            >
